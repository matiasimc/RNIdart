...
SubtypingConstraint meetConstraint(Constraint c1, Constraint c2) {
  return new SubtypingConstraint(c1.left, meet(c1.right, c2.right), c1.location, isFromMethodInvocation: c1.isFromMethodInvocation || c2.isFromMethodInvocation, invalidatingExpression: c1.invalidatingExpression != null ? c1.invalidatingExpression : c2.invalidatingExpression != null ? c2.invalidatingExpression : null);
}

SubtypingConstraint joinConstraint(Constraint c1, Constraint c2) {
  return new SubtypingConstraint(join(c1.left, c2.left), c1.right, c1.location, isFromMethodInvocation: c1.isFromMethodInvocation || c2.isFromMethodInvocation, invalidatingExpression: c1.invalidatingExpression != null ? c1.invalidatingExpression : c2.invalidatingExpression != null ? c2.invalidatingExpression : null);
}
